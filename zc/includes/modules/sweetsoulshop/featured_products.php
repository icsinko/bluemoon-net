...
if ($num_products_count > 0) {
  ...
  while (!$featured_products->EOF) {
    ...
    'text' => '<div class="thumb mask">' . zen_image(DIR_WS_IMAGES . $featured_products->fields['products_image'], $featured_products->fields['products_name'], IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH, IMAGE_FEATURED_PRODUCTS_LISTING_HEIGHT) . '<span class="mask-hover player-play"><p><a href="' . zen_href_link(zen_get_info_page($featured_products->fields['products_id']), 'products_id=' . $featured_products->fields['products_id']) . '">&gt;&nbsp;See Detail</a></p></span></div><p class="desc flag flag-deu"><a href="' . zen_href_link(zen_get_info_page($featured_products->fields['products_id']), 'products_id=' . $featured_products->fields['products_id']) . '"><strong>' . $featured_products->fields['products_name'] . '</strong><br /><span class="caption">' . $featured_products->fields['products_name'] . '</span></a></p>');
