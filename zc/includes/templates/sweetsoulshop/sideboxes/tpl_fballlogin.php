...
if (!empty($fbapikey)) {
	...
	if (isset($_SESSION['customer_id']) and $_SESSION['customer_id'] != '') {
		...
		<script src="'.DIR_WS_INCLUDES.'templates/sweetsoulshop/jscript/fball_connect.js"></script>
		<div class="fball_ui ">
		<div class="fball_form" title="Facebook All">
		<a href="javascript:void(0);" title="Facebook" class="fball_login_facebook"><img src="includes/templates/sweetsoulshop/'.DIR_WS_IMAGES.'fball_login.gif" style="cursor:pointer;" ></a> </div>
