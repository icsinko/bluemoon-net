...
/*
			var browserwidth = self.Window.width(),
			p = (page * browserwidth)+(browserwidth/2);
			self.catalogObj.wrapper.scrollLeft(p);
			self.catalogObj.isAnimate = false;
*/
			if(!self.isSP){
...
/*self.catalogObj.wrapper.scrollLeft(p).css({
	'-webkit-transform':'translate3d(all 3s linear)',
