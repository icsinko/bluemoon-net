		...
		setUpHtml: function(xml) {
			...
			slideXml.find('items item').each(function(i){
				...
				if(credit_src != self.options.imgDir){
					li_elm = $('<li class="slide"></li>').appendTo(self.galleryObj.slideUL).addClass(item_class).prepend('<img class="credit" src="' + credit_src + '" alt="' + credit_alt + '" />');
				}else{
			...
			self.galleryObj.slide.each(function(i){
				...
				collectionimg.onload = function() {
					...
					my.prepend('<img class="slide_img" src="' + images[i].src + '" alt="" />');
					...
					if(my.hasClass('top')){
						...
						top_html += '            <li><img src="images/collection_00-000.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_1"></a><img src="images/collection_00-001.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_2"></a><img src="images/collection_00-002.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_3"></a><img src="images/collection_00-003.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_4"></a><img src="images/collection_00-004.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_5"></a><img src="images/collection_00-005.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_6"></a><img src="images/collection_00-006.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_7"></a><img src="images/collection_00-007.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_8"></a><img src="images/collection_00-008.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_9"></a><img src="images/collection_00-009.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_10"></a><img src="images/collection_00-010.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_11"></a><img src="images/collection_00-011.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_12"></a><img src="images/collection_00-012.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_13"></a><img src="images/collection_00-013.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_14"></a><img src="images/collection_00-014.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_15"></a><img src="images/collection_00-015.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_16"></a><img src="images/collection_00-016.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_17"></a><img src="images/collection_00-017.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_18"></a><img src="images/collection_00-018.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_19"></a><img src="images/collection_00-019.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_20"></a><img src="images/collection_00-020.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_21"></a><img src="images/collection_00-021.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_22"></a><img src="images/collection_00-022.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_23"></a><img src="images/collection_00-023.jpg" alt="" class="toplink_img" /></li>';
						top_html += '            <li><a href="#page_24"></a><img src="images/collection_00-024.jpg" alt="" class="toplink_img" /></li>';
